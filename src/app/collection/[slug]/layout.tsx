...
import { NewCollectionResponse } from "@/utils/BubbleSpecialInterfaces";
...
export async function generateMetadata({
  ...
  try {
    // Fetch collection data using the new POST API endpoint
    const response = await axios.post(
      `${SPECIAL_BUBBLE_BASE_URL}/api/webClient/collection`,
      { slug },
      {
        headers: {
          "x-user-id": USER_ID,
