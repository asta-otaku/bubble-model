...
function cleanAttachmentReferences(description: string, attachments: any[]): string {
...
export async function generateMetadata({
  ...
  try {
    ...
    const cleanedDescription = cleanAttachmentReferences(rawDescription, attachments);
