...
import PauseIcon from "../assets/Bubble_Pause.svg";
import PlayIcon from "../assets/Bubble_Play.svg";
...
const BubbleAudioPlayer: React.FC<AudioPlayerProps> = ({
  audioUrl,
  filename,
  fileSize,
  startTime,
  ...
  // Audio is now loaded via the url parameter in useWavesurfer
  // No need for separate loading effect
...
export default BubbleAudioPlayer;