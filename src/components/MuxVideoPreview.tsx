...
import { MediaController, MediaControlBar, MediaTimeRange, MediaPlayButton, MediaFullscreenButton, MediaPreviewThumbnail, MediaPreviewTimeDisplay } from 'media-chrome/react';
...
export default function MuxVideoPreview({
  ...
  const paddingBottom = width && height ? `${(height / width) * 100}%` : "56.25%"; // 56.25% is 9/16 for default 16:9
          ...
          >
            ...
            >
              ...
              <MediaFullscreenButton style={fullscreenButtonStyle}>
                <span slot="enter">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18.9746 18.6426" width="14" height="14" fill="currentColor">
                ...
                <span slot="exit">
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.3945 19.5801" width="18" height="18" fill="currentColor">
